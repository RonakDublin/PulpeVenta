...
$result = mysqli_query($con,"select codpro,descripcion,precio from producto ORDER BY codpro");
$tg=0;
...
mysqli_close($con);
$pdf->Ln(5);
$pdf->Cell(135,5,"Cantidad de Articulos: ".$tg,0,0,'L',0);
$pdf->Output('Listado_Articulos.pdf','I');
?>
